...
All 7 originally-planned milestones are complete, plus Milestone 9; Milestone 8's deploy tooling is built and verified, with the live link itself pending the manual account steps above. See [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) for the full history, and the "Future work" section below for ideas beyond the original plan.
